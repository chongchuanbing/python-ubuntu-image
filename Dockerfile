...
#FROM nvidia/cuda${ARCH:+-$ARCH}:${CUDA}-cudnn${CUDNN}-runtime-ubuntu${UBUNTU_VERSION}
#
#ENV PATH /usr/local/bin:$PATH
#ENV LANG C.UTF-8
#
#COPY --from=python-builder /opt/product/python /opt/product/python
